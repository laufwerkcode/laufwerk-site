---
title: Migrating a syncthing installation
date: 2026-01-23
toc: true
mermaid: true
categories: ["homelab"]
...
# Setting up a Syncthing instance on TrueNAS
...
After all the data is migrated, you will need to transfer the config. The database syncthing uses will be rebuilt later when you restart syncthing. 

To find out where your config lives, you can run `syncthing paths`, for example:
...
![Syncthing in action](/assets/images/syncthings-in-action.png)
